...
<div class="ps-banner">
  ...
  <br>
    ...
    <div class="row">
       <div class="col-xs-6">
            <h3 class="ps-section__title" data-mask="Discover Our Menu">Discover Our Menu </h3>
        </div>
    </div>
</div>
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="images/photo-1603073163308-9654c3fb70b5.jpg" alt="IMG-MENU">

                                <!-- Button2 -->
                              
                                    <button onclick="document.location='http://127.0.0.1:8000/Listing?category=WESTERN&brand=&result='" type="button" class="btn btn-secondary flex-c-m txt5 ab-c-m size4">WESTERN</button>
                        ...
                        <div class="col-sm-6">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="images/istockphoto-1246401766-612x612.jpg" alt=" IMG-MENU ">

                                <!-- Button2 -->
                                <button onclick="document.location='http://127.0.0.1:8000/Listing?category=NASI+GORENG&brand=&result='"type="button" class="btn btn-secondary flex-c-m txt5 ab-c-m size4">NASI GORENG</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                ...
                                <!-- Button2 -->
                                <button onclick="document.location='http://127.0.0.1:8000/Listing?category=BEVERAGES&brand=&result='"type="button" class="btn btn-secondary flex-c-m txt5 ab-c-m size4">BEVERAGES</button>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <!-- Item our menu -->
                            <div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
                                <img src="images/photo-1551183053-bf91a1d81141.jpg" alt="IMG-MENU">

                                <!-- Button2 -->
                                <button onclick="document.location='http://127.0.0.1:8000/Listing?category=PASTA&brand=&result='"type="button" class="btn btn-secondary flex-c-m txt5 ab-c-m size4">PASTA</button>
                            </div>
                        </div>
