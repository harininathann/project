...
<head>
  ...
  <title>Curry & Go Café Admin Login</title>
  ...
  <div class="login-logo">
    <div class="center">
        <h1>
                ...
                <span class="red">Curry & Go Café Management System</span>
        </h1>
                <h4 class="blue" id="id-company-text">&copy; Curry & Go Café</h4>
    </div>
  </div>
   ...
   <hr>
    ...
    <hr>
        ...
        <div align="center" style="color: black;">
            © 2021 Curry & Go Café Web Design. All rights reserved v2.0 <br>
            Design by Curry & Go Café 
        </div>
