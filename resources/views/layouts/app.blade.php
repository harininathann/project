...
.pt-80 {
     padding-top:0px; 
     background-image: url('images/Can You Feel The Love Tonight.jpg');
}
...
.intro {
    ...
    text-align: center;
    color: #fff;
    background-image: radial-gradient(circle at 50% 50%,rgba(0,0,0,0.46),rgba(0,0,0,0.18)),url(https://images.unsplash.com/photo-1451337516015-6b6e9a44a8a3?crop=entropy&fit=crop&fm=jpg&h=675&ixjsv=2.1.0&ixlib=rb-0.3.5&q=80&w=1375);
...
.container-login100 {
  ...
  align-items: center;
  padding: 15px;
  background-image: url('https://news.olemiss.edu/wp-content/uploads/2020/06/UCIMG-1372-1.jpg');
}
